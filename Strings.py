...
#     spit_poems = poem.split(':')
#     highlighted_poems_details.append(spit_poems)
...
for data in daily_transactions_split:
    ...
    for item in data:
        stripped = item.strip()
        transactions_temp.append(stripped)
    transactions_clean.append(transactions_temp)
...
for sale in sales:
    ...
    thread_sales += amount
    thread_sales = round(thread_sales,2)
print(thread_sales)
...
for color in colors:
    ...
    print("Today we sold {} {} threads".format(number,color))
